...
const PersonalAdmin = {
    ...
    async listarPersonalConUsuario({ search } = {}) {
        let sql = `SELECT p.id_personal_adm AS personal_id, p.nombre_per, p.apellido, p.cargo_per, p.dni, u.id_usuarios AS usuario_id, u.nombre_usuario, u.roll, u.estado_us 
        FROM personal_adm p
