...
document.addEventListener('DOMContentLoaded', function () {
  if (window.location.pathname.endsWith('/aulasSecciones/secciones')) {
    cargarSecciones();
      ...
      secciones.forEach(sec => {
        html += `
          <tr>
            ...
            <td>
              <a href="/admin/aulasSecciones/secciones/editar?id=${sec.id_seccion}"><button>Editar</button></a>
...
document.addEventListener('DOMContentLoaded', function () {
  if (window.location.pathname.endsWith('/aulasSecciones/secciones/crear')) {
    // Cargar grados
      ...
      fetchAuth('/api/secciones', {
        ...
        .then(result => {
          if (result.message) {
            ...
            window.location.href = '/admin/aulasSecciones/secciones';
          } else {
...
document.addEventListener('DOMContentLoaded', function () {
  if (window.location.pathname.endsWith('/aulasSecciones/secciones/editar')) {
