document.addEventListener('DOMContentLoaded', function () {
    if (window.location.pathname.endsWith('/aulasSecciones/grados')) {
        cargarGrados();
...
document.addEventListener('DOMContentLoaded', function () {
  if (window.location.pathname.endsWith('/aulasSecciones/grados/crear')) {
    ...
    form.addEventListener('submit', function (e) {
      ...
      fetch('/api/grados', {
        ...
        .then(result => {
          if (result.message) {
            alert('Grado creado');
            window.location.href = '/admin/aulasSecciones/grados';
          } else {
...
document.addEventListener('DOMContentLoaded', function () {
  if (window.location.pathname.endsWith('/aulasSecciones/grados/editar')) {
