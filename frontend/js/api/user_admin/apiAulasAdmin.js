document.addEventListener('DOMContentLoaded', function () {
  ...
  if (window.location.pathname.endsWith('/aulasSecciones/aulas/crear')) {
    ...
    form.addEventListener('submit', function (e) {
      ...
      fetch('/api/aulas', {
        ...
        .then(result => {
          if (result.message) {
            alert('Aula creada');
            window.location.href = '/admin/aulasSecciones/aulas';
          } else {
  ...
  if (window.location.pathname.endsWith('/aulasSecciones/aulas/editar')) {
