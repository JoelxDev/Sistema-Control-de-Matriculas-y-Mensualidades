document.addEventListener('DOMContentLoaded', function () {
    if (window.location.pathname.endsWith('/aulasSecciones/niveles')) {
        cargarNiveles();
    ...
    fetch('/api/niveles')
      ...
      `;
          ...
          <tr>
            ...
            <td>
              <a href="/admin/aulasSecciones/niveles/editar?id=${niv.id_nivel}"><button>Editar</button></a>
...
document.addEventListener('DOMContentLoaded', function () {
    if (window.location.pathname.endsWith('/aulasSecciones/niveles/crear')) {
        ...
        form.addEventListener('submit', function (e) {
            ...
            fetch('/api/niveles', {
                ...
                .then(result => {
                    if (result.message) {
                        alert('Nivel creado');
                        window.location.href = '/admin/aulasSecciones/niveles';
                    } else {
...
document.addEventListener('DOMContentLoaded', function () {
    if (window.location.pathname.endsWith('/aulasSecciones/niveles/editar')) {
